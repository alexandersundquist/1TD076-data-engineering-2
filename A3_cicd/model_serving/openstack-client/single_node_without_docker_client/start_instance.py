...
instance = nova.servers.create(name="prod_server_without_docker_"+str(identifier), image=image, key_name='alex-sund-A3-key', flavor=flavor,userdata=userdata, nics=nics,security_groups=secgroups)
